...
describe('instantiate client', () => {
  ...
  describe('withOptions', () => {
    test('creates a new client with overridden options', () => {
      const client = new Kusto({ baseURL: 'http://localhost:5000/', maxRetries: 3, cluster: 'My-Cluster' });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Kusto({ baseURL: 'http://localhost:5000/', timeout: 1000, cluster: 'My-Cluster' });
